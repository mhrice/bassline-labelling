...
class BassLineTranscriber():
    ...
    def __init__(self, bass_line_path, BPM, M=M, N_bars=4, hop_ratio=HOP_RATIO, silence_code=0):
        """
    ...
    def create_MIDI_sequence(self):
        self.midi_sequence = frequency_to_midi_sequence(self.pitch_track[1], self.silence_code)
    ...
    def export_quantized_pitch_track(self):
        export_function(self.pitch_track, self.quantized_pitch_track_dir, self.title)